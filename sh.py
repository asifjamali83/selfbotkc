                        ...
                        pass
                         ...
                         for target in targets:
                             try:
                                  ...
                                  zxc = ""
                                  zx2 = []
                                  xpesan =  "「 Successes Invite 」\nNama "
                                  ret_ = "「Type invite off when it's  done」"
                                  ry = str(ryan.displayName)
                                  pesan = ''
                                  pesan2 = pesan+"@x\n"
                                  xlen = str(len(zxc)+len(xpesan))
                                  ...
                                  cl.sendText(msg.to,"You are hit by a limit")
                                  wait["invite"] = False
                                  break
#UPDATE FOTO
               if msg.contentType == 1:
                 if msg._from in admin:
                    if wait["Addimage"]["status"] == True:
                        ...
                        cl.sendMessage(msg.to, "Successful menambahkan gambar {}".format(str(wait["Addimage"]["name"])))
               ...
               if msg.contentType == 2:
                 if msg._from in admin:
                    if wait["Addvideo"]["status"] == True:
                        ...
                        cl.sendMessage(msg.to, "Successful menambahkan video {}".format(str(wait["Addvideo"]["name"])))
               ...
               if msg.contentType == 7:
                 if msg._from in admin:
                    if wait["Addsticker"]["status"] == True:
                        ...
                        cl.sendMessage(msg.to, "Successful menambahkan sticker {}".format(str(wait["Addsticker"]["name"])))
               ...
               if msg.contentType == 3:
                 if msg._from in admin:
                    if wait["Addaudio"]["status"] == True:
                        ...
                        cl.sendMessage(msg.to, "Successful menambahkan mp3 {}".format(str(wait["Addaudio"]["name"])))
               ...
               if msg.toType == 2:
                 if msg._from in admin:
                   if settings["groupPicture"] == True:
                     ...
                     cl.sendMessage(msg.to, "Successful mengubah foto group")
               if msg.contentType == 1:
                   if msg._from in admin:
                       if mid in Setmain["ARfoto"]:
                            ...
                            cl.sendMessage(msg.to,"Foto Successful dirubah")
               if msg.contentType == 2:
                   if msg._from in admin:
                       if mid in Setmain["ARvideo"]:
                            ...
                            cl.sendMessage(msg.to,"Foto Successful dirubah To video")
...
#CLONE
                          ...
                          if 'MENTION' in msg.contentMetadata.keys()!= None:
                                ...
                                for ls in lists:
                                    ...
                                    cl.sendMessage(to, "➧ Successful clone profile")
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                              ...
                              if ginvited != [] and ginvited != None:
                                  ...
                                  cl.sendMessage(to, "Successful tolak sebanyak {} undangan grup".format(str(len(ginvited))))
                              else:
...
#                                ret_ += "\n╚══[ Total {} Spam call]".format(str(dan[1]))
                                cl.sendMessage(msg.to, "Successful Sct ")
                          ...
                          if msg._from in admin:
                            ...
                            try:
                                ...
                                try:
                                    ...
                                    cl.sendText(msg.to, "Grup it does not exist")
                                    gCreator = "Tidak ditemukan"
                                if G.invitee is None:
                                    gPending = "0"
                                else:
...
#===========BOT UPDATE============#
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                              if msg.toType == 2:
                                ...
                                cl.sendText(msg.to,"Send fotonya.....")
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                ...
                                cl.sendText(msg.to,"Send videonya.....")
                          ...
                          if msg._from in admin:
                            ...
                            if len(string) <= 10000000000:
                                ...
                                cl.sendMessage(msg.to,"Name replaced To " + string + "")
#KICKALL
...
#===========BOT UPDATE============#
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                G = cl.getGroup(msg.to)
                                cl.sendText(msg.to, "Bye bye friends "+str(G.name))
...
#lurking
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                 ...
                                 cl.sendText(msg.to, "「 Status 」\nSuccessful activated, selanjutnya ketik lurkers\n\n• Jam [ "+ datetime.strftime(timeNow,'%H:%M:%S')+" ]"+"\n• Tanggal : "+ datetime.strftime(timeNow,'%Y-%m-%d'))
...
#===========Hiburan============#
                          ...
                          if wait["selfbot"] == True:
                           if msg._from in admin:
                                ...
                                num =  int(strnum)
                                Setmain["RAlimit"] = num
                                cl.sendText(msg.to,"「 Status Spamtag 」\nSuccessful changed To {} kali".format(str(strnum)))
                          ...
                          if wait["selfbot"] == True:
                           if msg._from in admin:
                             if msg.toType == 2:
                                ...
                                cl.sendMessage(msg.to, "Successful mengundang {} undangan Call Grup".format(str(wait["limit"])))
                          ...
                          if wait["selfbot"] == True:
                           if msg._from in admin:
                              ...
                              cl.sendText(msg.to,"「 Spam Gift 」\nSuccessful spamgift {} kali".format(str(jumlah)))
                              if jumlah <= 1000:
...
#=========== [ Add Image ] ============#
                          ...
                          if msg._from in admin:
                            ...
                            if name not in images:
                                ...
                                f = codecs.open("image.json","w","utf-8")
                                json.dump(images, f, sort_keys=True, indent=4, ensure_ascii=False)
                                cl.sendText(msg.to, "Please Send fotonya...")
                            else:
                          ...
                          if msg._from in admin:
                            ...
                            if name in images:
                                ...
                                f = codecs.open("image.json","w","utf-8")
                                json.dump(images, f, sort_keys=True, indent=4, ensure_ascii=False)
                                cl.sendText(msg.to, "Successful menghapus {}".format( str(name.lower())))
                            else:
                                cl.sendText(msg.to, "Foto it does not exist dalam list")
...
#=========== [ Add Video ] ============#
                          ...
                          if msg._from in admin:
                            ...
                            if name in videos:
                                ...
                                f = codecs.open("video.json","w","utf-8")
                                json.dump(videos, f, sort_keys=True, indent=4, ensure_ascii=False)
                                cl.sendText(msg.to, "Successful menghapus video {}".format( str(name.lower())))
                            else:
                                cl.sendText(msg.to, "Video it does not exist dalam list")
...
#=========== [ Add Video ] ============#
                          ...
                          if msg._from in admin:
                            ...
                            if name not in audios:
                                ...
                                f = codecs.open("audio.json","w","utf-8")
                                json.dump(audios, f, sort_keys=True, indent=4, ensure_ascii=False)
                                cl.sendText(msg.to, "Please Send mp3 nya...")
                            else:
                          ...
                          if msg._from in admin:
                            ...
                            if name in audios:
                                ...
                                f = codecs.open("audio.json","w","utf-8")
                                json.dump(audios, f, sort_keys=True, indent=4, ensure_ascii=False)
                                cl.sendText(msg.to, "Successful menghapus mp3 {}".format( str(name.lower())))
                            else:
                                cl.sendText(msg.to, "Mp3 it does not exist dalam list")
...
#=========== [ Add Sticker ] ============#
                          ...
                          if msg._from in admin:
                            ...
                            if name not in stickers:
                                ...
                                f = codecs.open("sticker.json","w","utf-8")
                                json.dump(stickers, f, sort_keys=True, indent=4, ensure_ascii=False)
                                cl.sendText(msg.to, "Please Send stickernya...")
                            else:
                          ...
                          if msg._from in admin:
                            ...
                            if name in stickers:
                                ...
                                f = codecs.open("sticker.json","w","utf-8")
                                json.dump(stickers, f, sort_keys=True, indent=4, ensure_ascii=False)
                                cl.sendText(msg.to, "Successful menghapus sticker {}".format( str(name.lower())))
                            else:
                                cl.sendText(msg.to, "Sticker it does not exist in list")
...
#===========ADMIN ADD============#
                            ...
                            if msg._from in admin:
                                ...
                                cl.sendMessage(msg.to,"Successful Refresh...")
                              ...
                              if spl == 'on':
                                  ...
                                  cl.sendMessage(msg.to, "「 Status Welcome 」\n" + msgs)
                                    ...
                                    if msg.to in welcome:
                                         ...
                                         msgs = "Welcome Msg is no longer active"
                                    cl.sendMessage(msg.to, "「 Status Welcome 」\n" + msgs)
                              ...
                              if spl == 'on':
                                  ...
                                  cl.sendMessage(msg.to, "「 Status Protect Url 」\n" + msgs)
                                    ...
                                    if msg.to in protectqr:
                                         ...
                                         msgs = "Protect url is no longer active"
                                    cl.sendMessage(msg.to, "「 Status Protect Url 」\n" + msgs)
                              ...
                              if spl == 'on':
                                  ...
                                  cl.sendMessage(msg.to, "「 Status Protect kick 」\n" + msgs)
                                    ...
                                    if msg.to in protectkick:
                                         ...
                                         msgs = "Protect kick is no longer active"
                                    cl.sendMessage(msg.to, "「 Status Protect kick 」\n" + msgs)
                              ...
                              if spl == 'on':
                                  ...
                                  cl.sendMessage(msg.to, "「 Status Protect Join 」\n" + msgs)
                                    ...
                                    if msg.to in protectjoin:
                                         ...
                                         msgs = "Protect join is no longer active"
                                    cl.sendMessage(msg.to, "「 Status Protect Join 」\n" + msgs)
                              ...
                              if spl == 'on':
                                  ...
                                  cl.sendMessage(msg.to, "「 Status Protect Cancel 」\n" + msgs)
                                    ...
                                    if msg.to in protectcancel:
                                         ...
                                         msgs = "Protect cancel is no longer active"
                                    cl.sendMessage(msg.to, "「 Status Protect Cancel 」\n" + msgs)
                              ...
                              if spl == 'on':
                                  ...
                                  cl.sendMessage(msg.to, "「 Status Protect Invite 」\n" + msgs)
                                    ...
                                    if msg.to in protectinvite:
                                         ...
                                         msgs = "Protect invite is no longer active"
                                    cl.sendMessage(msg.to, "「 Status Protect Invite 」\n" + msgs)
...
#===========COMMAND ON OFF============#
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                wait["unsend"] = True
                                sendMention(msg.to, sender, "「 Status 」\n\nUser ", "\nPlease unsend pesannya,\nKetik unsend off jika sudah slesai")

                        elif cmd == "unsend off" or text.lower() == 'unsend off':
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                wait["unsend"] = False
                                sendMention(msg.to, sender, "「 Status 」\n\nUser ", " \nDetection unsend deactivated")

                        elif cmd == "timeline on" or text.lower() == 'timeline on':
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                wait["Timeline"] = True
                                sendMention(msg.to, sender, "「 Status 」\n\nUser ", "\nPlease Send postingannya,\nKetik timeline off jika sudah slesai")

                        elif cmd == "timeline off" or text.lower() == 'timeline off':
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                wait["Timeline"] = False
                                sendMention(msg.to, sender, "「 Status 」\n\nUser ", " \nDetection timeline deactivated")

                        elif cmd == "invite on" or text.lower() == 'invite on':
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                wait["invite"] = True
                                sendMention(msg.to, sender, "「 Status 」\n\nUser ", "\nPlease Send his contact,\nType invite off when it's finished")

                        elif cmd == "invite off" or text.lower() == 'invite off':
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                wait["invite"] = False
                                sendMention(msg.to, sender, "「 Status 」\n\nUser ", " \nInvite via contact deactivated")

                        elif cmd == "notag on" or text.lower() == 'notag on':
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                wait["mentionKick"] = True
                                cl.sendText(msg.to,"「 Status 」\n\nNotag telah activated")

                        elif cmd == "notag off" or text.lower() == 'notag off':
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                wait["mentionKick"] = False
                                cl.sendText(msg.to,"「 Status 」\n\nNotag has been deactivated")

                        elif cmd == "contact on" or text.lower() == 'contact on':
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                wait["contact"] = True
                                sendMention(msg.to, sender, "「 Status 」\n\nUser ", "\nPlease Send his contact,\nWhen done, type the  contact off")

                        elif cmd == "contact off" or text.lower() == 'contact off':
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                wait["contact"] = False
                                cl.sendText(msg.to,"「 Status 」\n\nDetection contact deactivated")

                        elif cmd == "respon on" or text.lower() == 'respon on':
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                wait["detectMention"] = True
                                cl.sendText(msg.to,"「 Status 」\n\nAuto respon activated")

                        elif cmd == "respon off" or text.lower() == 'respon off':
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                wait["detectMention"] = False
                                cl.sendText(msg.to,"「 Status 」\n\nAuto respon deactivated")

                        elif cmd == "autojoin on" or text.lower() == 'autojoin on':
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                wait["autoJoin"] = True
                                cl.sendText(msg.to,"「 Status 」\n\nAutojoin telah activated")

                        elif cmd == "autojoin off" or text.lower() == 'autojoin off':
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                wait["autoJoin"] = False
                                cl.sendText(msg.to,"「 Status 」\n\nAutojoin has been deactivated")

                        elif cmd == "autoleave on" or text.lower() == 'autoleave on':
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                wait["autoLeave"] = True
                                cl.sendText(msg.to,"「 Status 」\n\nAutoleave telah diaktifka")

                        elif cmd == "autoleave off" or text.lower() == 'autoleave off':
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                wait["autoLeave"] = False
                                cl.sendText(msg.to,"「 Status 」\n\nAutoleave has been deactivated")
...
#===========COMMAND SET============#
                           ...
                           if msg._from in admin:
                              ...
                              if spl in [""," ","\n",None]:
                                  ...
                                  wait["message"] = spl
                                  cl.sendMessage(msg.to, "「 Successful replaced 」\nPesan Msg replaced To :\n\n{}".format(str(spl)))
